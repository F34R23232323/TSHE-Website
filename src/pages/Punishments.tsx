    ...
    <div style={{ position: 'relative', zIndex: 1, maxWidth: 900, margin: '0 auto', padding: '3rem 1.5rem 6rem' }}>
      ...
      <div style={{ background: 'var(--bg1)', border: '1px solid var(--border)', borderRadius: '1rem', overflow: 'hidden', marginBottom: '2rem' }}>
        <div style={{ padding: '1.25rem 1.5rem', borderBottom: '1px solid var(--border)', display: 'flex', alignItems: 'center', gap: '.65rem' }}>
          ...
          <h2 style={{ fontFamily: 'var(--display)', fontSize: '.88rem', fontWeight: 700, letterSpacing: '.05em' }}>Punishment Tiers</h2>
        </div>
              ...
              <tr style={{ background: 'var(--bg2)' }}>
                {['Tier', 'Level', 'Duration', 'Description'].map(h => (
                  <th key={h} style={{
                    ...
                    fontFamily: 'var(--display)', fontSize: '.6rem', letterSpacing: '.1em',
                ...
                <tr key={t.level} style={{ borderBottom: '1px solid rgba(255,255,255,.04)' }}>
                  <td style={{ padding: '.75rem 1rem' }}>
                    <div style={{
                      ...
                      fontFamily: 'var(--display)', fontSize: '.7rem', fontWeight: 800, color: t.color,
                    }}>{t.level}</div>
                  </td>
                  <td style={{ padding: '.75rem 1rem', color: t.color, fontFamily: 'var(--display)', fontSize: '.75rem', fontWeight: 700 }}>{t.label}</td>
      ...
      <div data-reveal style={{ background: 'var(--bg1)', border: '1px solid var(--border)', borderRadius: '1rem', overflow: 'hidden', marginBottom: '2rem' }}>
        <div style={{ padding: '1.25rem 1.5rem', borderBottom: '1px solid var(--border)', display: 'flex', alignItems: 'center', gap: '.65rem' }}>
          ...
          <h2 style={{ fontFamily: 'var(--display)', fontSize: '.88rem', fontWeight: 700, letterSpacing: '.05em' }}>Warning Escalation Ladder</h2>
        </div>
              ...
              return (
                <div key={w.warns} style={{
                  ...
                  <div style={{
                    ...
                    <span style={{ fontFamily: 'var(--display)', fontSize: '.7rem', fontWeight: 800, color }}>{w.warns}</span>
                  </div>
                  <div style={{ flex: 1 }}>
        ...
        {[
          ...
          <div key={n.title} style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '.4rem', marginBottom: '.5rem' }}>
              ...
              <p style={{ fontFamily: 'var(--display)', fontSize: '.78rem', fontWeight: 700, color: 'var(--gold)' }}>{n.title}</p>
            </div>
