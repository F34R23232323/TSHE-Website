      ...
      <div style={{ maxWidth: 1000, margin: '0 auto', padding: '3rem 1.5rem 6rem' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: '4rem' }}>
          ...
          <h1 data-reveal data-delay="1" style={{
            ...
            background: 'linear-gradient(135deg, var(--gold2), #a78bfa, var(--gold))',
        ...
        <div data-reveal style={{
          ...
          {[
            { to: '/rules', label: 'Rules', icon: BookOpen, color: 'var(--red2)' },
            ...
            { to: '/partnership', label: 'Partner', icon: Users, color: 'var(--red2)' },
          ].map(q => {
            const QIcon = q.icon
            return (
        ...
        <div style={{ position: 'relative' }}>
          ...
          <div style={{
            ...
            bottom: 0,
            width: 2,
            background: 'linear-gradient(180deg, var(--red2) 0%, rgba(200,30,50,.2) 50%, rgba(200,30,50,0) 100%)',
            borderRadius: 1,
          }} />
              ...
              return (
                <div key={i} data-reveal data-delay={String((i % 4) + 1)} style={{
                  ...
                  <div style={{
                    ...
                    height: 26,
                    borderRadius: '50%',
                    background: `rgba(${u.color === 'var(--gold)' ? '201,168,76' : u.color.replace('#', '').match(/.{2}/g)!.map(h => parseInt(h, 16)).join(',')},.15)`,
                  ...
                  onMouseEnter={e => {
                    e.currentTarget.style.borderColor = `rgba(${u.color === 'var(--gold)' ? '201,168,76' : '200,30,50'},.25)`
